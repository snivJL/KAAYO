      ...
      >
        <div className="max-h-screen">
          ...
          <p className="legend-custom relative">
            <div className="flex flex-col w-5/6 mx-auto pt-36 md:pt-4 h-full justify-center text-gray-700 font-extralight">
        ...
        <div>
          ...
          />
          <p className="legend-custom relative">
            <div className="flex flex-col w full md:w-5/6 mx-auto h-full justify-center  text-gray-700 font-extralight		">
