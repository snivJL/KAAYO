  ...
  return (
    <Nav className="justify-content-center">
      <Nav.Item className={step1 && !step2 && "border-b-2 border-green-600"}>
        {step1 ? (
          <Nav.Link as={Link} to="/order/shipping">
            Shipping
          </Nav.Link>
        ) : (
      ...
      <Nav.Item className={step2 && !step3 && "border-b-2 border-green-600"}>
        {step2 ? (
          <Nav.Link as={Link} to="/order/payment">
            Payment
          </Nav.Link>
        ) : (
      ...
      <Nav.Item className={step3 && "border-b-2 border-green-600"}>
        {step4 ? (
          <Nav.Link as={Link} to="order/placeorder">
            Place Order
          </Nav.Link>
        ) : (
